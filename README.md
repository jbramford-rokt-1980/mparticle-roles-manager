...
Each customer environment needs a Platform API credential with **Custom Roles** access (Admin, org-level):

1. In the customer's mParticle dashboard: Settings → API Credentials → Add Credential.
2. Select the **Custom Roles** API, Admin permissions. Only Custom Role Admins can do this.
